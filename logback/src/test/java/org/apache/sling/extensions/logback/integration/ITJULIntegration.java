...
//                paxRunnerVmOption = DEBUG_VM_OPTION;
    ...
    protected Option addExtraOptions() {
        return composite(
                ...
                .value(FilenameUtils.concat(new File(".").getAbsolutePath(),
                        "src/test/resources/test-jul-config.xml"))
        );
    }
    ...
    public void testJULLogging() throws Exception {
        java.util.logging.Logger julLogger
                = java.util.logging.Logger.getLogger("foo.jul.1");
        org.slf4j.Logger slf4jLogger
                = LoggerFactory.getLogger("foo.jul.1");
